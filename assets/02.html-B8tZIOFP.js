import{ar as n,as as a,at as p,au as e}from"./app-5nod3Nrs.js";const l={};function i(t,s){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h1 id="二、嵌套" tabindex="-1"><a class="header-anchor" href="#二、嵌套"><span>二、嵌套</span></a></h1><h2 id="_2-1-less-级联" tabindex="-1"><a class="header-anchor" href="#_2-1-less-级联"><span>2.1 Less 级联</span></a></h2><p>使你能够使用嵌套代替级联，或与级联结合使用。</p><p><strong>编译前LESS</strong></p><div class="language-less line-numbers-mode" data-highlighter="prismjs" data-ext="less"><pre><code class="language-less"><span class="line"><span class="token comment">// less 代码编辑</span></span>
...
<span class="line">  <span class="token property">margin-left</span><span class="token punctuation">:</span> 5px<span class="token punctuation">;</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-替代" tabindex="-1"><a class="header-anchor" href="#_2-2-替代"><span>2.2 &amp; 替代</span></a></h2><p><strong>编译前LESS</strong></p><div class="language-less line-numbers-mode" data-highlighter="prismjs" data-ext="less"><pre><code class="language-less"><span class="line"><span class="token comment">// less 代码编辑</span></span>
