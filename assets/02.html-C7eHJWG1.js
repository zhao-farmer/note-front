import{ar as n,as as a,at as e,au as i}from"./app-5nod3Nrs.js";const l="/note-front/framework/vue/vue3/001.png",p="/note-front/framework/vue/vue3/002.png",t="/note-front/framework/vue/vue3/003.png",c="/note-front/framework/vue/vue3/004.png",r="/note-front/framework/vue/vue3/005.png",o="/note-front/framework/vue/vue3/006.png",d="/note-front/framework/vue/vue3/007.png",m={};function u(v,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="二、-创建vue3工程" tabindex="-1"><a class="header-anchor" href="#二、-创建vue3工程"><span>二、 创建Vue3工程</span></a></h1><h2 id="_3-1-【基于-vue-cli-创建】" tabindex="-1"><a class="header-anchor" href="#_3-1-【基于-vue-cli-创建】"><span>3.1 【基于 vue-cli 创建】</span></a></h2><p>点击查看 <a href="https://cli.vuejs.org/zh/guide/creating-a-project.html#vue-create" target="_blank" rel="noopener noreferrer">官方文档</a></p><p>备注：目前vue-cli已处于维护模式，官方推荐基于 Vite 创建项目。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment">## 查看@vue/cli版本，确保@vue/cli版本在4.5.0以上</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>项目结构说明</li></ul><p><img src="`+t+'" alt=""></p><p>其中env.d.ts 文件是让ts文件认识 各种类型的其他文件点进去可以进行查看</p><p><img src="'+c+'" alt=""></p><p><img src="'+r+'" alt=""></p><ul><li>安装插件（官方插件，只安装这一个）</li></ul><p><img src="'+o+'" alt=""></p><p>总结：</p><ul><li>Vite 项目中，index.html 是项目的入口文件，在项目最外层。</li><li>加载index.html后，Vite 解析 <code>&lt;script type=&quot;module&quot; src=&quot;xxx&quot;&gt;</code> 指向的JavaScript。</li><li>Vue3**中是通过 **createApp 函数创建一个应用实例。</li></ul><h2 id="_3-3-项目工程文件" tabindex="-1"><a class="header-anchor" href="#_3-3-项目工程文件"><span>3.3 项目工程文件</span></a></h2><ol><li>index.html（入口文件）</li></ol><p><img src="'+d+`" alt=""></p><ol start="2"><li>引入了main.ts</li></ol><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code class="language-typescript"><span class="line"><span class="token comment">/* 引入样式 */</span></span>
