import{aq as n,ar as a,as as p,ay as e}from"./app-BVlFcd65.js";const l={};function t(c,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="二、语法扩张" tabindex="-1"><a class="header-anchor" href="#二、语法扩张"><span>二、语法扩张</span></a></h1><h2 id="_2-1选择器嵌套-nested-selector" tabindex="-1"><a class="header-anchor" href="#_2-1选择器嵌套-nested-selector"><span>2.1选择器嵌套 (Nested Selector)</span></a></h2><p>可以使用不同的选择器进行嵌套，可更方便与直观的查看与管理选择器的父子级关系</p><p><strong>编译前SCSS</strong></p><div class="language-scss line-numbers-mode" data-highlighter="prismjs" data-ext="scss"><pre><code><span class="line"><span class="token comment">// scss 代码编辑</span></span>
