import{_ as n,c as a,b as p,o as e}from"./app-BmLMK3lt.js";const l={};function t(i,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="四、-变量" tabindex="-1"><a class="header-anchor" href="#四、-变量"><span>四、 变量</span></a></h1><ol><li><p>定义语法：@var:value;</p></li><li><p>使用变量：@var</p><ol><li>作为普通的值使用</li><li>选择器变量</li><li>属性变量</li><li>url 变量</li><li>声明变量</li></ol></li><li><p>变量的作用域 和js中变量作用域一致</p></li></ol><p>代码演示： //1.定义变量 @变量:变量值;</p><pre><code>//2.选择器变量 
</code></pre><p><strong>编译前LESS</strong></p><div class="language-less line-numbers-mode" data-highlighter="prismjs" data-ext="less" data-title="less"><pre><code><span class="line"><span class="token comment">// less 代码编辑</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8)]))}const o=n(l,[["render",t],["__file","04.html.vue"]]),u=JSON.parse('{"path":"/style/pre_compile_css/less/04.html","title":"四、 变量","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1744806830000,"contributors":[{"name":"zhao-farmer","username":"zhao-farmer","email":"857899180@qq.com","commits":1,"url":"https://github.com/zhao-farmer"}]},"filePathRelative":"style/pre_compile_css/less/04.md"}');export{o as comp,u as data};
