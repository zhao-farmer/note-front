import{aq as n,ar as a,au as p,at as e}from"./app-Ci8NOINE.js";const l={};function t(c,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="四、-变量" tabindex="-1"><a class="header-anchor" href="#四、-变量"><span>四、 变量</span></a></h1><ol><li><p>定义语法：@var:value;</p></li><li><p>使用变量：@var</p><ol><li>作为普通的值使用</li><li>选择器变量</li><li>属性变量</li><li>url 变量</li><li>声明变量</li></ol></li><li><p>变量的作用域 和js中变量作用域一致</p></li></ol><p>代码演示： //1.定义变量 @变量:变量值;</p><pre><code>//2.选择器变量 
