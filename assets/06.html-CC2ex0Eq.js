import{aq as s,ar as a,au as p,at as t}from"./app-Ci8NOINE.js";const e="/note-front/application/weixin/base/075.png",l="/note-front/application/weixin/base/076.png",i="/note-front/application/weixin/base/077.png",c="/note-front/application/weixin/base/078.png",o="/note-front/application/weixin/base/079.png",u={};function d(r,n){return t(),a("div",null,n[0]||(n[0]=[p(`<h1 id="六、生命周期" tabindex="-1"><a class="header-anchor" href="#六、生命周期"><span>六、生命周期</span></a></h1><h2 id="_6-1-小程序运行机制" tabindex="-1"><a class="header-anchor" href="#_6-1-小程序运行机制"><span>6.1 小程序运行机制</span></a></h2><ol><li><p>小程序启动</p><code><pre class="mermaid" id="mermaid-apnht6q">            flowchart LR
    ...
    D --&gt; |30分后| E[小程序销毁]
          ...
          </pre></code><p>小程序启动可以分为两种情况，一种是冷启动，一种是热启动</p><ul><li>冷启动:如果用户首次打开，或小程序销毁后被用户再次打开，此时小程序需要重新加载</li><li>启动热启动:如果用户已经打开过某小程序，然后在一定时间内再次打开该小程序，此时小程序并未被销毁，只是从后台状态进入前台状态</li></ul></li><li><p>前台 和 后台状态</p><code><pre class="mermaid" id="mermaid-g6qrf6q">            flowchart LR
    A[小程序冷启动] --&gt; |启动| B[前台]
    subgraph 前后台状态
    B --&gt; |切后台| C[后台]
    C --&gt; |切前台| B
    ...
    D --&gt; |30分后| E[小程序销毁]
          ...
          </pre></code><p>小程序启动后，界面被展示给用户，此时小程序处于「前台」状态。当用户「关闭」小程序时，小程序并没有真正被关闭，而是进入了「后台」状态，当用户再次进入微信并打开小程序，小程序又会重新进入「前台」状态</p></li><li><p>挂起</p><code><pre class="mermaid" id="mermaid-sh2qkog">            flowchart LR
    A[小程序冷启动] --&gt; |启动| B[前台]
    B --&gt; |切后台| C[后台]
    C --&gt; |切前台| B
    C --&gt; |5秒后 | D[挂起]
