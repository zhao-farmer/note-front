import{aq as n,ar as a,au as p,at as e}from"./app-Ci8NOINE.js";const l={};function t(i,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="九、其他" tabindex="-1"><a class="header-anchor" href="#九、其他"><span>九、其他</span></a></h1><h2 id="_9-1-转义-escaping" tabindex="-1"><a class="header-anchor" href="#_9-1-转义-escaping"><span>9.1 转义（Escaping）</span></a></h2><p>转义（Escaping）允许你使用任意字符串作为属性或变量值。任何 ~&quot;anything&quot; 或 ~&#39;anything&#39; 形式的内容都将按原样输出，除非 interpolation。</p><p><strong>编译前LESS</strong></p><div class="language-less line-numbers-mode" data-highlighter="prismjs" data-ext="less"><pre><code><span class="line"><span class="token comment">// less 代码编辑</span></span>
