import{aq as s,ar as a,as as e,at as p}from"./app-Cok9BT0p.js";const t={};function i(l,n){return p(),a("div",null,n[0]||(n[0]=[e(`<h1 id="九、滤镜-混合模式" tabindex="-1"><a class="header-anchor" href="#九、滤镜-混合模式"><span>九、滤镜/混合模式</span></a></h1><p>PixiJS滤镜允许您对任何场景对象及其子对象应用后处理视觉效果。滤镜可用于诸如模糊、颜色调整、噪声或基于自定义着色器的操作等效果。</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> Sprite<span class="token punctuation">,</span> BlurFilter <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;pixi.js&#39;</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-1-应用过滤器" tabindex="-1"><a class="header-anchor" href="#_9-1-应用过滤器"><span>9.1 应用过滤器</span></a></h2><p>应用过滤器很简单。您可以将过滤器实例分配给任何场景对象的 <code>filters</code> 属性，例如 <code>Sprite</code> ,  <code>Container</code> ，或 <code>Graphics</code> 。 您可以通过传递筛选器实例数组来应用多个筛选器。</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> BlurFilter<span class="token punctuation">,</span> NoiseFilter <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;pixi.js&#39;</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>信息</p><p>顺序很重要——过滤器是按顺序应用的。</p><hr><h2 id="_9-2-高级混合模式" tabindex="-1"><a class="header-anchor" href="#_9-2-高级混合模式"><span>9.2 高级混合模式</span></a></h2><p>PixiJS v8为滤镜引入了高级混合模式，允许更复杂的合成效果。这些混合模式可以用来创建独特的视觉风格和效果。 要使用像 <code>HARD_LIGHT</code> 这样的高级模式，你必须手动导入高级混合模式扩展：</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code><span class="line"><span class="token keyword">import</span> <span class="token string">&#39;pixi.js/advanced-blend-modes&#39;</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_9-3-内置过滤器概述" tabindex="-1"><a class="header-anchor" href="#_9-3-内置过滤器概述"><span>9.3 内置过滤器概述</span></a></h2><p>PixiJS v8提供了多种现成的过滤器：</p><table><thead><tr><th>过滤器类</th><th>描述</th></tr></thead><tbody><tr><td><code>AlphaFilter</code></td><td>对对象应用透明度。</td></tr><tr><td><code>BlurFilter</code></td><td>高斯模糊。</td></tr><tr><td><code>ColorMatrixFilter</code></td><td>通过矩阵应用颜色变换。</td></tr><tr><td><code>DisplacementFilter</code></td><td>使用另一个纹理扭曲对象。</td></tr><tr><td><code>NoiseFilter</code></td><td>为颗粒效果添加随机噪声。</td></tr></tbody></table><p>信息</p><p>要探索更多的社区过滤器，请参阅pixi-filters。</p><p>混合过滤器：用于自定义合成模式</p><table><thead><tr><th>过滤器类</th><th>描述</th></tr></thead><tbody><tr><td><code>ColorBurnBlend</code></td><td>使基色变暗以反映混合色。</td></tr><tr><td><code>ColorDodgeBlend</code></td><td>提亮底色。</td></tr><tr><td><code>DarkenBlend</code></td><td>保留最暗的颜色成分。</td></tr><tr><td><code>DivideBlend</code></td><td>将基色除以混合色。</td></tr><tr><td><code>HardMixBlend</code></td><td>高对比度的融合。</td></tr><tr><td><code>LinearBurnBlend</code></td><td>使用线性公式变暗。</td></tr><tr><td><code>LinearDodgeBlend</code></td><td>使用线性公式进行减亮。</td></tr><tr><td><code>LinearLightBlend</code></td><td>线性闪避和燃烧的组合。</td></tr><tr><td><code>PinLightBlend</code></td><td>选择性更换颜色。</td></tr><tr><td><code>SubtractBlend</code></td><td>从底色中减去混合色。</td></tr></tbody></table><hr><h2 id="_9-4-创建自定义过滤器" tabindex="-1"><a class="header-anchor" href="#_9-4-创建自定义过滤器"><span>9.4 创建自定义过滤器</span></a></h2><p>要在PixiJS v8中定义自定义过滤器，您可以在着色程序和GPU资源中使用 <code>Filter.from()</code> 。</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> Filter<span class="token punctuation">,</span> GlProgram<span class="token punctuation">,</span> Texture <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;pixi.js&#39;</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>提示</strong></p><p>着色器必须与WebGL或webgpu兼容。对于双渲染器支持，包括 <code>gpuProgram</code> 。</p>`,26)]))}const o=s(t,[["render",i]]),r=JSON.parse('{"path":"/animation/pixi/official/09.html","title":"九、滤镜/混合模式","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1752490925000,"contributors":[{"name":"zhao-farmer","username":"zhao-farmer","email":"857899180@qq.com","commits":1,"url":"https://github.com/zhao-farmer"}],"changelog":[{"hash":"08d014805d6447d2221b34fe03fdc2ca18411d66","time":1752490925000,"email":"857899180@qq.com","author":"zhao-farmer","message":"2025年7月更新"}]},"filePathRelative":"animation/pixi/official/09.md"}');export{o as comp,r as data};
