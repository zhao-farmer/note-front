import{ar as s,as as a,at as e,au as p}from"./app-5nod3Nrs.js";const t={};function i(l,n){return p(),a("div",null,[...n[0]||(n[0]=[e(`<h1 id="九、滤镜-混合模式" tabindex="-1"><a class="header-anchor" href="#九、滤镜-混合模式"><span>九、滤镜/混合模式</span></a></h1><p>PixiJS滤镜允许您对任何场景对象及其子对象应用后处理视觉效果。滤镜可用于诸如模糊、颜色调整、噪声或基于自定义着色器的操作等效果。</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code class="language-typescript"><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> Sprite<span class="token punctuation">,</span> BlurFilter <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;pixi.js&#39;</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>信息</p><p>顺序很重要——过滤器是按顺序应用的。</p><hr><h2 id="_9-2-高级混合模式" tabindex="-1"><a class="header-anchor" href="#_9-2-高级混合模式"><span>9.2 高级混合模式</span></a></h2><p>PixiJS v8为滤镜引入了高级混合模式，允许更复杂的合成效果。这些混合模式可以用来创建独特的视觉风格和效果。 要使用像 <code>HARD_LIGHT</code> 这样的高级模式，你必须手动导入高级混合模式扩展：</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre><code class="language-typescript"><span class="line"><span class="token keyword">import</span> <span class="token string">&#39;pixi.js/advanced-blend-modes&#39;</span><span class="token punctuation">;</span></span>
