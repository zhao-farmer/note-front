import{ar as s,as as a,at as i,au as e}from"./app-5nod3Nrs.js";const l={};function c(r,n){return e(),a("div",null,[...n[0]||(n[0]=[i(`<h1 id="十五、桑基图" tabindex="-1"><a class="header-anchor" href="#十五、桑基图"><span>十五、桑基图</span></a></h1><blockquote><p>桑基图是用于描述从一组值到另一组值的流的可视化图。</p></blockquote><blockquote><ol><li>这是一张实验图。它的语法非常接近纯CSV，但它将在不久的将来得到扩展。</li><li>被连接的东西被称为节点，连接被称为链接。</li></ol></blockquote><h2 id="_15-1-例子" tabindex="-1"><a class="header-anchor" href="#_15-1-例子"><span>15.1 例子</span></a></h2><p>这个例子取自observable。不过，在大小和颜色方面，它可能会被渲染得有点不同。</p><ul><li>代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">---</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-qeyw0mk">            ---
config:
  sankey:
    showValues: false
---
...
Electricity grid,H2 conversion,27.14
          ...
          </pre></code><h3 id="_15-2-2-空行" tabindex="-1"><a class="header-anchor" href="#_15-2-2-空行"><span>15.2.2 空行</span></a></h3><p>CSV默认不支持不带逗号分隔符的空行。但如果需要，你可以添加它们：</p><ul><li>代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">sankey-beta</span>
<span class="line"></span>
<span class="line">Bio-conversion,Losses,26.862</span>
<span class="line"></span>
<span class="line">Bio-conversion,Solid,280.322</span>
<span class="line"></span>
<span class="line">Bio-conversion,Gas,81.144</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-1i62v5z">            sankey-beta
...
Bio-conversion,Gas,81.144
          ...
          </pre></code><h3 id="_15-2-3-逗号" tabindex="-1"><a class="header-anchor" href="#_15-2-3-逗号"><span>15.2.3 逗号</span></a></h3><p>如果你需要逗号，用双引号括起来：</p><ul><li>代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">sankey-beta</span>
<span class="line"></span>
<span class="line">Pumped heat,&quot;Heating and cooling, homes&quot;,193.026</span>
<span class="line">Pumped heat,&quot;Heating and cooling, commercial&quot;,70.672</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-t264fo4">            sankey-beta

Pumped heat,&quot;Heating and cooling, homes&quot;,193.026
Pumped heat,&quot;Heating and cooling, commercial&quot;,70.672

          </pre></code><h3 id="_15-2-4-双引号" tabindex="-1"><a class="header-anchor" href="#_15-2-4-双引号"><span>15.2.4 双引号</span></a></h3><p>如果你需要双引号，把一对双引号放在带引号的字符串里：</p><ul><li>代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">sankey-beta</span>
<span class="line"></span>
<span class="line">Pumped heat,&quot;Heating and cooling, &quot;&quot;homes&quot;&quot;&quot;,193.026</span>
<span class="line">Pumped heat,&quot;Heating and cooling, &quot;&quot;commercial&quot;&quot;&quot;,70.672</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-a6n0fpz">            sankey-beta
