import{aq as e,ar as a,au as s,at as i}from"./app-Ci8NOINE.js";const t={};function l(o,n){return i(),a("div",null,n[0]||(n[0]=[s(`<h1 id="十八、包图" tabindex="-1"><a class="header-anchor" href="#十八、包图"><span>十八、包图</span></a></h1><h2 id="_18-1-包图基础" tabindex="-1"><a class="header-anchor" href="#_18-1-包图基础"><span>18.1 包图基础</span></a></h2><ol><li>介绍</li></ol><p>包图是用来说明网络包的结构和内容的可视化表示。网络数据包是通过网络传输的数据的基本单位。</p><ol start="2"><li>用法</li></ol><p>这种图表类型对于开发人员、网络工程师、教育工作者和学生特别有用，他们需要一种清晰而简洁的方式来表示网络数据包的结构。</p><h2 id="_18-2-语法" tabindex="-1"><a class="header-anchor" href="#_18-2-语法"><span>18.2 语法</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">packet-beta</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-g8jkleq">            ---
title: &quot;TCP Packet&quot;
---
packet-beta
0-15: &quot;Source Port&quot;
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>展示图</li></ul><code><pre class="mermaid" id="mermaid-w70hgxx">            packet-beta
title UDP Packet
0-15: &quot;Source Port&quot;
16-31: &quot;Destination Port&quot;
32-47: &quot;Length&quot;
