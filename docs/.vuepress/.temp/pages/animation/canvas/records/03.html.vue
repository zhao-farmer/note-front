...
<p><img src="/animation/canvas/records/042.png" alt=""></p>
<ul>
...
<p><img src="/animation/canvas/records/043.png" alt=""></p>
<ul>
<li>坐标轴解释</li>
</ul>
<p><img src="/animation/canvas/records/044.png" alt=""></p>
...
<p><img src="/animation/canvas/records/047.png" alt=""></p>
...
<p><img src="/animation/canvas/records/048.png" alt=""></p>
<ul>
<li>如果不想相互污染，需要做2件事：
<ol>
...
<p><img src="/animation/canvas/records/049.png" alt=""></p>
<p>第一条线的样式会影响之后的线。</p>
...
<p><img src="/animation/canvas/records/050.png" alt=""></p>
<ol start="3">
...
<p><img src="/animation/canvas/records/051.png" alt=""></p>
<ol start="4">
<li>正确的做法</li>
</ol>
...
<p><img src="/animation/canvas/records/052.png" alt=""></p>
...
<p><img src="/animation/canvas/records/053.png" alt=""></p>
...
<p><img src="/animation/canvas/records/054.png" alt=""></p>
<ul>
<li>坐标轴</li>
</ul>
<p><img src="/animation/canvas/records/055.png" alt=""></p>
...
<p><img src="/animation/canvas/records/056.png" alt=""></p>
<ul>
<li>坐标轴</li>
</ul>
<p><img src="/animation/canvas/records/057.png" alt=""></p>
...
<p><img src="/animation/canvas/records/058.png" alt=""></p>
...
<p><img src="/animation/canvas/records/059.png" alt=""></p>
...
<p><img src="/animation/canvas/records/060.png" alt=""></p>
...
<p><img src="/animation/canvas/records/061.png" alt=""></p>
...
<p><img src="/animation/canvas/records/062.png" alt=""></p>
<blockquote>
...
<p><img src="/animation/canvas/records/063.png" alt=""></p>
...
<p><img src="/animation/canvas/records/064.png" alt=""></p>
...
<p><img src="/animation/canvas/records/065.png" alt=""></p>
...
<p><img src="/animation/canvas/records/066.png" alt=""></p>
...
<p><img src="/animation/canvas/records/067.png" alt=""></p>
...
<p><img src="/animation/canvas/records/068.png" alt=""></p>
<p>上面的代码中，cxt.arc 最后一个参数没传，默认是 false ，所以是顺时针绘制。</p>
<ul>
<li>坐标轴</li>
</ul>
<p><img src="/animation/canvas/records/069.png" alt=""></p>
...
<p><img src="/animation/canvas/records/070.png" alt=""></p>
...
<p><img src="/animation/canvas/records/071.png" alt=""></p>
<ul>
<li>坐标轴</li>
</ul>
<p>原理如下图所示，红线代表画出来的那条弧线。</p>
<p><img src="/animation/canvas/records/072.png" alt=""></p>
...
<p><img src="/animation/canvas/records/073.png" alt=""></p>
<ul>
<li>代码</li>
</ul>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>canvas</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>c<span class="token punctuation">"</span></span> <span class="token attr-name">width</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>300<span class="token punctuation">"</span></span> <span class="token attr-name">height</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>300<span class="token punctuation">"</span></span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">border</span><span class="token punctuation">:</span> 1px solid #ccc<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>canvas</span><span class="token punctuation">></span></span></span>
