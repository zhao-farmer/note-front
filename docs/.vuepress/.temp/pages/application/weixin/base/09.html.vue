<template><div><h1 id="九、npm支持" tabindex="-1"><a class="header-anchor" href="#九、npm支持"><span>九、npm支持</span></a></h1>
<h2 id="_9-1-如何使用npm包" tabindex="-1"><a class="header-anchor" href="#_9-1-如何使用npm包"><span>9.1 如何使用npm包</span></a></h2>
<ol>
<li>
<p>介绍</p>
<p>目前小程序已经支持使用 npm 安装第三方包，因为 node_modules 目录中的包不会参与小程序项目的编译、上传和打包，因此在小程序项目中要使用的 npm 包，必须走一遍 构建 npm 的过程。</p>
<p>在构建成功以后，默认 会在小程序项目根目录也就是 node_modules 同级目录下生成 miniprogram_npm 目录,里面存放着构建完成以后的 npm 包，也就是小程序运行过程中真正使用的包</p>
</li>
<li>
<p>使用步骤</p>
<ol>
<li>
<p>进入终端</p>
<p><img src="/application/weixin/base/116.png" alt=""></p>
</li>
<li>
<p>npm初始化</p>
...
<ul>
<li>
<p><a href="https://vant.pro/vant-weapp/#/quickstart" target="_blank" rel="noopener noreferrer">进入网站</a></p>
</li>
<li>
<p>复制 npm 安装</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> i @vant/weapp </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
<li>
<p>构建npm包</p>
<p><img src="/application/weixin/base/117.png" alt=""></p>
</li>
<li>
<p>目录结果</p>
<p><img src="/application/weixin/base/118.png" alt=""></p>
</li>
</ol>
</li>
<li>
<p>注意事项</p>
<p>小程序运行在微信内部，因为运行环境的特殊性，这就导致并不是所有的包都能在小程序中使用</p>
<p>我们在小程序中提到的包指专为小程序定制的 npm 包，简称小程序 npm 包，在使用包之前需要先确定该包是否支持小程序</p>
<p>开发者如果需要发布小程序包，<a href="https://developers.weixin.qq.com/miniprogram/dev/devtools/npm.html" target="_blank" rel="noopener noreferrer">需要参考官方规范</a></p>
</li>
</ol>
<h2 id="_9-2-自定义构建-npm" tabindex="-1"><a class="header-anchor" href="#_9-2-自定义构建-npm"><span>9.2 自定义构建 npm</span></a></h2>
<ol>
<li>
<p>问题</p>
<p>在实际的开发中，随着项目的功能越来越多、项目越来越复杂，文件目录也变的很繁琐，为了方便进行项目的开发，开发人员通常会对目录结构进行调整优化，例如:将小程序源码放到 <code v-pre>miniprogram</code> 目录下</p>
<p>这时候需要开发者在 <code v-pre>project.config.json</code> 中指定 <code v-pre>node_modules</code> 的位置 和 目标 <code v-pre>miniprogram_npm</code> 的位置</p>
</li>
<li>
<p>具体配置如下</p>
<ol>
<li>配置 <code v-pre>project.config.json</code> 的 <code v-pre>miniprogramRoot</code> 指定小程序源码的目录</li>
<li>配置 <code v-pre>project.config.json</code> 的 <code v-pre>setting.packNpmManually </code>为 true，开启自定义 <code v-pre>node_modules</code> 和 <code v-pre>miniprogram_npm</code> 位置的构建 npm 方式</li>
<li>配置 <code v-pre>project.config.json</code> 的 <code v-pre>setting.packNpmRelationList</code> 项，指定 <code v-pre>packageJsonPath </code>和 <code v-pre>miniprogramNpmDistDir</code> 的位置.</li>
</ol>
</li>
<li>
<p>操作后的目录结构</p>
<p><img src="/application/weixin/base/119.png" alt=""></p>
</li>
</ol>
<h2 id="_9-3-vant组件库的使用" tabindex="-1"><a class="header-anchor" href="#_9-3-vant组件库的使用"><span>9.3 vant组件库的使用</span></a></h2>
<ol>
<li>
<p>去除 <code v-pre>project.config.json</code> 配置中的 <code v-pre> &quot;style&quot;: &quot;v2&quot;,</code></p>
</li>
<li>
<p><a href="https://vant.pro/vant-weapp/#/image" target="_blank" rel="noopener noreferrer">UI页面中的使用方式</a></p>
</li>
<li>
<p>使用</p>
<ul>
...
<p>index.wxml</p>
<div class="language-xml line-numbers-mode" data-highlighter="prismjs" data-ext="xml"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>van-image</span> <span class="token attr-name">width</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>100<span class="token punctuation">"</span></span> <span class="token attr-name">height</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>100<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>https://img.yzcdn.cn/vant/cat.jpeg<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></span>
...
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css"><pre v-pre><code><span class="line"><span class="token selector">.custom-class</span><span class="token punctuation">{</span></span>
...
<h2 id="_9-4-vant-weapp-组件样式覆盖" tabindex="-1"><a class="header-anchor" href="#_9-4-vant-weapp-组件样式覆盖"><span>9.4 vant Weapp 组件样式覆盖</span></a></h2>
<ol>
<li>
<p>介绍</p>
<p>Vant Weapp 基于微信小程序的机制，为开发者提供了3种修改组件样式的方法</p>
<ol>
<li>解除样式隔离:在页面中使用 Vant Weapp 组件时，可直接在页面的样式文件中覆盖样式</li>
<li>使用外部样式类:需要注意的是普通样式类和外部样式类的优先级是未定义的，使用时需要添加 imporant 保证外部样式类的优先级</li>
<li>使用 CSS 变量:在页面或全局对多个组件的样式做批量修改以进行主题样式的定制</li>
</ol>
</li>
<li>
<p>代码示例</p>
...
<p>页面代码</p>
<p>cart.wxml</p>
<div class="language-xml line-numbers-mode" data-highlighter="prismjs" data-ext="xml"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- 外部样式类 --></span></span>
...
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css"><pre v-pre><code><span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>custom01.wxml</p>
<div class="language-xml line-numbers-mode" data-highlighter="prismjs" data-ext="xml"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>van-button</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>primary<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>组件按钮<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>van-button</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>custom01.wxss</p>
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css"><pre v-pre><code><span class="line"><span class="token comment">/* 在自定义组件中如果需要 Vant weapp 组件的样式，需要解除样式的隔离,shared */</span></span>
...
<li>
<p>运行结果</p>
<p><img src="/application/weixin/base/120.png" alt=""></p>
</li>
</ul>
</li>
</ol>
