<template><div><h1 id="一、认识node-js" tabindex="-1"><a class="header-anchor" href="#一、认识node-js"><span>一、认识node.js</span></a></h1>
...
<h3 id="_1-1-1-基本介绍" tabindex="-1"><a class="header-anchor" href="#_1-1-1-基本介绍"><span>1.1.1 基本介绍</span></a></h3>
<ol>
<li>
...
<h3 id="_1-1-2-nodejs架构图" tabindex="-1"><a class="header-anchor" href="#_1-1-2-nodejs架构图"><span>1.1.2 NodeJS架构图</span></a></h3>
...
<h3 id="_1-1-3-nodejs-应用场景" tabindex="-1"><a class="header-anchor" href="#_1-1-3-nodejs-应用场景"><span>1.1.3 Nodejs 应用场景</span></a></h3>
...
<h2 id="_1-2-模块化" tabindex="-1"><a class="header-anchor" href="#_1-2-模块化"><span>1.2 模块化</span></a></h2>
<p>Node.js 中两大主流的模块化规范：经典的 <strong>CommonJS (CJS)</strong> 和现代标准的 <strong>ES Modules (ESM)</strong>。理解它们的工作原理、差异以及如何在项目中选择和使用，是每一位 Node.js 开发者必备的核心技能。让我们一起学习代码的“整理术”吧！</p>
<h3 id="_1-2-1-告别混乱-为何我们需要模块化" tabindex="-1"><a class="header-anchor" href="#_1-2-1-告别混乱-为何我们需要模块化"><span>1.2.1 告别混乱：为何我们需要模块化？</span></a></h3>
<p>在模块化概念出现之前，JavaScript 代码（尤其是在早期浏览器环境中）常常面临一些棘手的问题：</p>
<ol>
<li><strong>全局命名空间污染:</strong> 所有变量、函数都定义在全局作用域下，很容易发生命名冲突，一个脚本不小心覆盖了另一个脚本的变量，导致难以追踪的 bug。就像往一个公共池塘里扔东西，很快就乱成一团。</li>
<li><strong>代码组织困难:</strong> 大型项目的所有代码挤在一个或少数几个文件里，逻辑混乱，难以定位和修改特定功能。</li>
<li><strong>复用性差:</strong> 想要复用一段代码，往往只能复制粘贴，一旦原始代码需要修改，所有副本都需要同步更新，费时费力还容易出错。</li>
<li><strong>依赖管理混乱:</strong> 文件之间的依赖关系不明确，不知道修改一个文件会影响到哪些其他文件，维护成本极高。</li>
</ol>
<p><strong>模块化就是解决这些问题的良药！</strong> 一个良好的模块系统能带来诸多好处：</p>
<ul>
<li><strong>封装与隔离:</strong> 每个模块都有自己的作用域，内部变量和函数默认对外不可见，避免了全局污染。</li>
<li><strong>明确的接口:</strong> 模块通过特定的语法（如 <code v-pre>exports</code> 或 <code v-pre>export</code>）显式地暴露希望对外提供的功能。</li>
<li><strong>代码复用:</strong> 可以轻松地将通用功能封装成模块，在需要的地方导入即可。</li>
<li><strong>依赖清晰:</strong> 模块之间的依赖关系通过导入语句（如 <code v-pre>require</code> 或 <code v-pre>import</code>）明确声明，易于管理和理解。</li>
<li><strong>可维护性:</strong> 将大型项目拆分成更小、更专注的模块，使得代码更容易理解、测试和维护。</li>
<li><strong>团队协作:</strong> 不同开发者可以并行开发不同的模块，减少互相干扰。</li>
</ul>
<p>Node.js 选择了模块化作为其核心特性之一，为构建大型、复杂的服务器端应用奠定了基础。</p>
<h3 id="_1-2-2-node-js-的-老臣-commonjs-cjs-规范" tabindex="-1"><a class="header-anchor" href="#_1-2-2-node-js-的-老臣-commonjs-cjs-规范"><span>1.2.2 Node.js 的“老臣”：CommonJS (CJS) 规范</span></a></h3>
<p>Node.js 在早期采用了 <strong>CommonJS</strong> 规范作为其模块系统。即使现在 ES Modules 已经成为官方标准，CommonJS 仍然在庞大的 Node.js 生态系统中广泛使用，理解它至关重要。</p>
<p><strong>核心概念：</strong></p>
<ol>
<li>
<p><strong><code v-pre>require()</code> - 导入模块:</strong></p>
<ul>
<li><strong>作用:</strong> 用于在一个模块中加载并执行另一个模块，并返回该模块导出的内容 (<code v-pre>module.exports</code>)。</li>
<li><strong>同步加载:</strong> 这是 CommonJS 最重要的特性之一。当执行到 <code v-pre>require()</code> 时，Node.js 会<strong>暂停当前模块的执行</strong>，去查找、加载、编译并执行被依赖的模块，拿到其 <code v-pre>module.exports</code> 后，再<strong>恢复当前模块的执行</strong>。这在服务器启动时加载依赖通常没问题，但在某些场景下可能成为性能瓶颈。</li>
<li><strong>路径解析:</strong> <code v-pre>require()</code> 查找模块的规则：
<ul>
<li><strong>核心模块:</strong> 如果是 Node.js 内置模块（如 <code v-pre>http</code>, <code v-pre>fs</code>, <code v-pre>path</code>），直接返回核心模块。</li>
<li><strong>路径模块:</strong> 如果以 <code v-pre>/</code>, <code v-pre>./</code>, <code v-pre>../</code> 开头，则按相对路径或绝对路径查找 <code v-pre>.js</code>, <code v-pre>.json</code>, <code v-pre>.node</code> 文件。</li>
<li><strong>第三方模块:</strong> 如果是非路径、非核心模块（如 <code v-pre>require('express')</code>），Node.js 会从当前目录的 <code v-pre>node_modules</code> 文件夹开始查找，如果找不到，再往上一级目录的 <code v-pre>node_modules</code> 查找，依此类推，直到根目录。</li>
</ul>
</li>
<li><strong>模块缓存:</strong> 为了提高性能，Node.js 会缓存已加载的模块。第一次 <code v-pre>require()</code> 一个模块时，它会被加载、执行并缓存。后续再次 <code v-pre>require()</code> 同一个模块时，会直接从缓存中返回 <code v-pre>module.exports</code>，不会重复执行模块代码。</li>
</ul>
</li>
<li>
<p><strong><code v-pre>module.exports</code> - 导出模块内容:</strong></p>
<ul>
<li><strong><code v-pre>module</code> 对象:</strong> 每个 CommonJS 模块内部都有一个 <code v-pre>module</code> 对象，它代表当前模块。</li>
<li><strong><code v-pre>module.exports</code> 属性:</strong> <code v-pre>module</code> 对象有一个 <code v-pre>exports</code> 属性（即 <code v-pre>module.exports</code>），<strong>这个属性的初始值是一个空对象 <code v-pre>{}</code></strong>。<strong><code v-pre>require()</code> 函数最终返回的就是目标模块的 <code v-pre>module.exports</code> 的值。</strong></li>
<li><strong>导出方式:</strong> 你可以给这个空对象添加属性来导出多个值，也可以直接将 <code v-pre>module.exports</code> 赋值为一个函数、类、数组、字符串等任何你想导出的单一值。</li>
</ul>
</li>
<li>
<p><strong><code v-pre>exports</code> - <code v-pre>module.exports</code> 的便捷别名:</strong></p>
<ul>
<li>为了方便，Node.js 在每个模块顶部还提供了一个变量 <code v-pre>exports</code>，它<strong>默认指向 <code v-pre>module.exports</code></strong> (<code v-pre>exports = module.exports</code>)。</li>
<li><strong>作用:</strong> 你可以直接通过 <code v-pre>exports.propertyName = value</code> 的方式来添加导出项，这实际上是修改了 <code v-pre>module.exports</code> 对象。</li>
<li><strong>重要陷阱 (The Pitfall):</strong> <strong>永远不要直接给 <code v-pre>exports</code> 变量赋值 (<code v-pre>exports = ...</code>)！</strong> 因为这样做只会改变 <code v-pre>exports</code> 变量本身的指向，让它不再指向 <code v-pre>module.exports</code>。而 <code v-pre>require()</code> 最终返回的是 <code v-pre>module.exports</code>，不是 <code v-pre>exports</code>。</li>
</ul>
</li>
</ol>
<p><strong>代码示例：</strong></p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// math.js - 定义一个数学模块 (CommonJS)</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// app.js - 使用 math 模块 (CommonJS)</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>CommonJS 总结:</strong> 简单、直观、同步加载、通过 <code v-pre>require</code> 导入、通过 <code v-pre>module.exports</code> 或 <code v-pre>exports</code> 导出。它是 Node.js 世界的基石。</p>
<h3 id="_1-2-3-现代标准-es-modules-esm" tabindex="-1"><a class="header-anchor" href="#_1-2-3-现代标准-es-modules-esm"><span>1.2.3 现代标准：ES Modules (ESM)</span></a></h3>
<p>随着 ECMAScript 2015 (ES6) 的发布，JavaScript 拥有了官方的、标准化的模块系统——<strong>ES Modules (ESM)</strong>。Node.js 从 v8.5.0 版本开始实验性支持，并在 v13.2.0 版本后正式稳定支持。ESM 旨在提供一个统一的、跨平台（浏览器和服务器）的模块解决方案。</p>
<p><strong>核心概念：</strong></p>
<ol>
<li>
<p><strong><code v-pre>export</code> - 导出模块内容:</strong></p>
<ul>
<li>
<p><strong>命名导出 (Named Exports):</strong> 可以导出多个变量、函数或类。使用 <code v-pre>export</code> 关键字。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// utils.mjs - 使用命名导出</span></span>
...
<li>
<p><strong>默认导出 (Default Export):</strong> 每个模块只能有一个默认导出。通常用于导出模块的主要功能（比如一个类或函数）。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// logger.mjs - 使用默认导出</span></span>
...
<li>
<p><strong><code v-pre>import</code> - 导入模块内容:</strong></p>
<ul>
<li>
<p><strong>导入命名导出:</strong> 使用花括号 <code v-pre>{}</code> 指定要导入的变量名，名称必须与导出时一致。可以 使用 <code v-pre>as</code> 重命名。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.mjs</span></span>
...
<li>
<p><strong>导入默认导出:</strong> 直接给导入的值指定一个名称。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.mjs</span></span>
...
<li>
<p><strong>导入整个模块 (Namespace Import):</strong> 将模块的所有命名导出作为一个对象导入。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.mjs</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><strong>动态导入 <code v-pre>import()</code>:</strong> ESM 还提供了 <code v-pre>import()</code> 函数，它返回一个 Promise，允许你在运行时<strong>异步地</strong>加载模块。这对于代码分割、按需加载非常有用。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.mjs</span></span>
...
<p><strong>如何在 Node.js 中使用 ESM？</strong></p>
<p>Node.js 需要明确知道某个文件应该被当作 ESM 模块来处理。主要有两种方式：</p>
<ol>
<li><strong>使用 <code v-pre>.mjs</code> 文件扩展名:</strong> 将你的模块文件命名为 <code v-pre>.mjs</code> 后缀。Node.js 会自动将其识别为 ESM。</li>
<li><strong>在 <code v-pre>package.json</code> 中设置 <code v-pre>&quot;type&quot;: &quot;module&quot;</code>:</strong>
<ul>
<li>在项目的 <code v-pre>package.json</code> 文件中添加顶级字段 <code v-pre>&quot;type&quot;: &quot;module&quot;</code>。</li>
<li>这样设置后，该项目下的所有 <code v-pre>.js</code> 文件（以及没有扩展名的文件）都会被默认视为 ESM。</li>
<li>如果你在这种模式下仍需要使用 CommonJS 文件，可以将该文件的扩展名改为 <code v-pre>.cjs</code>。</li>
</ul>
</li>
</ol>
<p><strong>ESM 的关键特性:</strong></p>
<ul>
<li><strong>静态分析 (Static Structure):</strong> <code v-pre>import</code> 和 <code v-pre>export</code> 语句只能出现在模块的顶层作用域（不能在函数或条件语句中）。这使得工具（如打包器、代码检查器）可以在<strong>不执行代码</strong>的情况下分析模块依赖关系，实现 Tree Shaking（移除未使用的代码）等优化。</li>
<li><strong>异步加载设计:</strong> ESM 标准本身是围绕异步加载设计的（尽管 Node.js 的底层加载在某些情况下可能是同步完成的），更适合浏览器环境和未来的异步场景。</li>
<li><strong><code v-pre>this</code> 指向:</strong> 在 ESM 模块的顶层作用域中，<code v-pre>this</code> 的值是 <code v-pre>undefined</code>。而在 CommonJS 中，顶层 <code v-pre>this</code> 指向 <code v-pre>module.exports</code>。</li>
</ul>
<p><strong>代码示例 (ESM):</strong></p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// geometry.mjs</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// app.mjs (假设 package.json 中有 "type": "module", 或者此文件为 app.mjs)</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>ESM 总结:</strong> ECMAScript 官方标准、静态分析、设计上异步、通过 <code v-pre>import</code>/<code v-pre>export</code> 导入导出。是 JavaScript 模块化的未来趋势。</p>
<h3 id="_1-2-4-commonjs-vs-es-modules-终极对决" tabindex="-1"><a class="header-anchor" href="#_1-2-4-commonjs-vs-es-modules-终极对决"><span>1.2.4 CommonJS vs ES Modules: 终极对决</span></a></h3>
<table>
<thead>
<tr>
<th>特性</th>
...
<td><code v-pre>require</code>, <code v-pre>module.exports</code>, <code v-pre>exports</code></td>
<td><code v-pre>import</code>, <code v-pre>export</code>, <code v-pre>export default</code></td>
</tr>
<tr>
<td><strong>加载方式</strong></td>
<td>同步</td>
<td>设计上异步 (Node.js 实现有优化)</td>
</tr>
<tr>
<td><strong>语法位置</strong></td>
<td>可在代码任意位置 <code v-pre>require</code></td>
<td><code v-pre>import</code>/<code v-pre>export</code> 必须在顶层</td>
</tr>
<tr>
...
<tr>
<td><strong><code v-pre>this</code> (顶层)</strong></td>
<td>指向 <code v-pre>module.exports</code></td>
<td><code v-pre>undefined</code></td>
</tr>
<tr>
<td><strong>Node.js 用法</strong></td>
<td>默认 (<code v-pre>.js</code>, <code v-pre>.cjs</code>)</td>
<td>需配置 (<code v-pre>.mjs</code> 或 <code v-pre>package.json</code> “type”: “module”)</td>
</tr>
<tr>
<td><strong>导出值类型</strong></td>
<td>值的<strong>拷贝</strong> (基本类型), 值的<strong>引用</strong> (对象)</td>
<td>值的<strong>实时绑定</strong> (Live Binding)</td>
</tr>
<tr>
<td><strong>浏览器兼容</strong></td>
<td>不原生支持 (需打包工具)</td>
<td>原生支持</td>
</tr>
</tbody>
</table>
<p><strong>值的实时绑定 (Live Binding) 解释:</strong> 在 ESM 中，导入的变量是原始模块中导出变量的一个只读<strong>绑定</strong>，而不是简单的值拷贝。如果导出模块内部修改了导出的变量（仅限 <code v-pre>var</code>/<code v-pre>let</code> 声明的，<code v-pre>const</code> 不行），导入方也能看到这个变化。CommonJS 导出基本类型时是值的拷贝。</p>
<p><strong>互操作性 (Interoperability):</strong></p>
<p>Node.js 允许在一定程度上混合使用两种模块：</p>
<ul>
<li>
<p><strong>在 ESM 文件中导入 CJS 模块:</strong> 通常是<strong>可以</strong>的。你可以使用 <code v-pre>import</code> 语句导入 CommonJS 模块。Node.js 会尝试将 <code v-pre>module.exports</code> 转换为 ESM 的默认导出。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.mjs</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><strong>在 CJS 文件中导入 ESM 模块:</strong> <strong>不能</strong>直接使用 <code v-pre>require()</code> 来导入 ESM 模块。这会抛出错误。必须使用<strong>动态 <code v-pre>import()</code> 函数</strong>，它返回一个 Promise。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// main.cjs</span></span>
...
<h3 id="_1-2-5-抉择时刻-选择哪个模块系统" tabindex="-1"><a class="header-anchor" href="#_1-2-5-抉择时刻-选择哪个模块系统"><span>1.2.5 抉择时刻：选择哪个模块系统？</span></a></h3>
<p>面对 CJS 和 ESM，我们该如何选择？</p>
<ul>
<li><strong>新项目:</strong> 强烈<strong>推荐使用 ES Modules (ESM)</strong>。它是 JavaScript 的官方标准，代表着未来方向，拥有静态分析等优势，且与浏览器端统一。设置 <code v-pre>&quot;type&quot;: &quot;module&quot;</code> 在 <code v-pre>package.json</code> 中是目前的主流做法。</li>
<li><strong>现有大型 CommonJS 项目:</strong> 迁移到 ESM 可能需要不少工作量。可以考虑：
<ul>
<li><strong>维持 CommonJS:</strong> 如果项目稳定，迁移成本高，可以继续使用 CJS。</li>
<li><strong>逐步迁移:</strong> 对于新开发的功能或模块，可以尝试使用 <code v-pre>.mjs</code> 或在特定子目录配置 <code v-pre>&quot;type&quot;: &quot;module&quot;</code> 来引入 ESM，并处理好与现有 CJS 代码的互操作。</li>
<li><strong>混合使用:</strong> 在 ESM 项目中导入 CJS 库通常没问题。在 CJS 项目中需要使用 ESM 库时，利用动态 <code v-pre>import()</code>。</li>
</ul>
</li>
<li><strong>需要广泛兼容旧环境/工具:</strong> 某些旧的 Node.js 工具或运行环境可能对 ESM 支持不完善，这种情况下 CJS 可能更稳妥。</li>
<li><strong>库/包的开发者:</strong> 需要考虑你的用户群体。提供双模块格式（同时提供 CJS 和 ESM 入口）是目前比较友好的做法（通常通过 <code v-pre>package.json</code> 的 <code v-pre>exports</code> 字段配置）。</li>
</ul>
<p><strong>最佳实践:</strong></p>
<ul>
<li><strong>保持一致:</strong> 在一个项目中尽量使用同一种模块系统。</li>
<li><strong>明确导出:</strong> 只导出模块真正需要对外提供的接口。</li>
<li><strong>单一职责:</strong> 让每个模块专注于做好一件事。</li>
<li><strong>避免循环依赖:</strong> A 依赖 B，B 又依赖 A。这在 CJS 中可能导致部分导出为空对象，在 ESM 中会抛出错误。需要通过重构代码来解决。</li>
</ul>
<h3 id="_1-2-6-常见陷阱与解惑-faq" tabindex="-1"><a class="header-anchor" href="#_1-2-6-常见陷阱与解惑-faq"><span>1.2.6 常见陷阱与解惑 (FAQ)</span></a></h3>
<ul>
<li><strong>Q1: <code v-pre>exports = ...</code> 为什么不行？</strong>
<ul>
<li><strong>A:</strong> 因为 <code v-pre>exports</code> 只是 <code v-pre>module.exports</code> 的一个引用。直接给 <code v-pre>exports</code> 赋值，只是让 <code v-pre>exports</code> 指向了新对象，而 <code v-pre>module.exports</code> 没变。<code v-pre>require</code> 返回的是 <code v-pre>module.exports</code>。始终通过 <code v-pre>exports.prop = value</code> 或直接修改 <code v-pre>module.exports</code> 来导出。</li>
</ul>
</li>
<li><strong>Q2: 为什么在 ESM 文件里 <code v-pre>require</code> is not defined?</strong>
<ul>
<li><strong>A:</strong> 因为 ESM 使用 <code v-pre>import</code> 关键字，<code v-pre>require</code> 是 CommonJS 的特性。在 ESM 文件中，<code v-pre>require</code>, <code v-pre>module</code>, <code v-pre>exports</code>, <code v-pre>__filename</code>, <code v-pre>__dirname</code> 这些 CJS 特有的全局变量或对象默认是不可用的。可以使用 <code v-pre>import.meta.url</code> 来获取当前文件路径。</li>
</ul>
</li>
<li><strong>Q3: 尝试 <code v-pre>require()</code> 一个 <code v-pre>.mjs</code> 文件时报错怎么办？</strong>
<ul>
<li><strong>A:</strong> 不能直接用 <code v-pre>require</code> 加载 ESM 模块。需要使用动态 <code v-pre>import()</code> 函数：<code v-pre>import('./your-module.mjs').then(...)</code>。</li>
</ul>
</li>
<li><strong>Q4: <code v-pre>__dirname</code> 和 <code v-pre>__filename</code> 在 ESM 中怎么获取？</strong>
<ul>
<li>
<p><strong>A:</strong> 不能直接用。可以使用 <code v-pre>import.meta.url</code> 结合 <code v-pre>url</code> 和 <code v-pre>path</code> 模块来获取：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> fileURLToPath <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'url'</span><span class="token punctuation">;</span></span>
...
<h3 id="_1-2-7-总结-模块化是基石" tabindex="-1"><a class="header-anchor" href="#_1-2-7-总结-模块化是基石"><span>1.2.7 总结：模块化是基石</span></a></h3>
<p>模块化是构建可维护、可扩展 Node.js 应用的基础。今天我们详细学习了 Node.js 中的两大模块系统：</p>
<ul>
<li><strong>CommonJS (CJS):</strong> Node.js 的传统模块系统，使用 <code v-pre>require</code> 和 <code v-pre>module.exports</code>/<code v-pre>exports</code>，同步加载，简单易懂，生态庞大。</li>
<li><strong>ES Modules (ESM):</strong> JavaScript 官方标准，使用 <code v-pre>import</code> 和 <code v-pre>export</code>/<code v-pre>export default</code>，静态分析，设计上异步，是未来的趋势</li>
</ul>
</div></template>
