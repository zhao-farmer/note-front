<template><div><h1 id="二、npm的使用" tabindex="-1"><a class="header-anchor" href="#二、npm的使用"><span>二、npm的使用</span></a></h1>
<h2 id="_2-1-包和npm" tabindex="-1"><a class="header-anchor" href="#_2-1-包和npm"><span>2.1 包和npm</span></a></h2>
<h3 id="_2-1-1-什么是包" tabindex="-1"><a class="header-anchor" href="#_2-1-1-什么是包"><span>2.1.1 什么是包</span></a></h3>
...
<h3 id="_2-1-2-包的加载机制" tabindex="-1"><a class="header-anchor" href="#_2-1-2-包的加载机制"><span>2.1.2 包的加载机制</span></a></h3>
...
<p>比如说：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token function">requiere</span><span class="token punctuation">(</span><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">fs</span><span class="token template-punctuation string">`</span></span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
...
<h3 id="_2-1-3-npm-的概念" tabindex="-1"><a class="header-anchor" href="#_2-1-3-npm-的概念"><span>2.1.3 npm 的概念</span></a></h3>
...
<h3 id="_2-1-4-npm-的安装-不需要单独安装" tabindex="-1"><a class="header-anchor" href="#_2-1-4-npm-的安装-不需要单独安装"><span>2.1.4 npm 的安装（不需要单独安装）</span></a></h3>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> <span class="token function">install</span> <span class="token function">npm</span> <span class="token parameter variable">-g</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="_2-1-5-配置-npm-的全局目录" tabindex="-1"><a class="header-anchor" href="#_2-1-5-配置-npm-的全局目录"><span>2.1.5 配置 NPM 的全局目录</span></a></h3>
<p>NPM 默认安装到当前正在使用 Node 版本所在目录下。我们建议重新配置 NPM 的全局目录。</p>
<p>输入npm config ls，查看配置信息</p>
<h2 id="_2-2-npm-命令" tabindex="-1"><a class="header-anchor" href="#_2-2-npm-命令"><span>2.2 NPM 命令</span></a></h2>
<h3 id="_2-2-1-设置npm路径" tabindex="-1"><a class="header-anchor" href="#_2-2-1-设置npm路径"><span>2.2.1 设置npm路径</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment">#全局安装路径</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-2-设置镜像" tabindex="-1"><a class="header-anchor" href="#_2-2-2-设置镜像"><span>2.2.2 设置镜像</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># 1淘宝镜像源</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-3-常用命令简写说明" tabindex="-1"><a class="header-anchor" href="#_2-2-3-常用命令简写说明"><span>2.2.3 常用命令简写说明</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line">-g： <span class="token comment">#--global 的缩写，表示安装到全局目录里</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-4-初始化" tabindex="-1"><a class="header-anchor" href="#_2-2-4-初始化"><span>2.2.4 初始化</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># npm 初始化当前目录</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-4-安装模块" tabindex="-1"><a class="header-anchor" href="#_2-2-4-安装模块"><span>2.2.4 安装模块</span></a></h3>
<ol>
<li>普通安装</li>
</ol>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> i   <span class="token comment"># 安装所有依赖</span></span>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> i express <span class="token parameter variable">-g</span>  <span class="token comment"># 会安装到配置的全局目录下</span></span>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># 安装特定版本</span></span>
...
<span class="line"><span class="token function">npm</span> <span class="token function">install</span> react@~17.0.0</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-5-卸载模块" tabindex="-1"><a class="header-anchor" href="#_2-2-5-卸载模块"><span>2.2.5 卸载模块</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> uninstall express  <span class="token comment"># 卸载模块，但不卸载模块留在package.json中的对应信息</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-6-更新模块" tabindex="-1"><a class="header-anchor" href="#_2-2-6-更新模块"><span>2.2.6 更新模块</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> update express  <span class="token comment"># 更新最新版本的express</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-7-查看命令" tabindex="-1"><a class="header-anchor" href="#_2-2-7-查看命令"><span>2.2.7 查看命令</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> <span class="token parameter variable">-v</span>   <span class="token comment">#查看版本号</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-8-其他命令" tabindex="-1"><a class="header-anchor" href="#_2-2-8-其他命令"><span>2.2.8 其他命令</span></a></h3>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> cache clean  <span class="token comment"># 清除npm的缓存</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-package-json文件与package-lock-json" tabindex="-1"><a class="header-anchor" href="#_2-4-package-json文件与package-lock-json"><span>2.4 package.json文件与package-lock.json</span></a></h2>
<h3 id="_2-4-1-生成文件" tabindex="-1"><a class="header-anchor" href="#_2-4-1-生成文件"><span>2.4.1 生成文件</span></a></h3>
<ol>
<li>执行命令</li>
</ol>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># 初始化npm</span></span>
<span class="line"><span class="token function">npm</span> init </span>
...
<h3 id="_2-4-2-package-json-配置" tabindex="-1"><a class="header-anchor" href="#_2-4-2-package-json-配置"><span>2.4.2 package.json 配置</span></a></h3>
<ul>
...
<h3 id="_2-4-3-package-lock-json" tabindex="-1"><a class="header-anchor" href="#_2-4-3-package-lock-json"><span>2.4.3 package-lock.json</span></a></h3>
<ul>
...
<h3 id="_2-4-4-什么是-npm-脚本" tabindex="-1"><a class="header-anchor" href="#_2-4-4-什么是-npm-脚本"><span>2.4.4 什么是 npm 脚本</span></a></h3>
