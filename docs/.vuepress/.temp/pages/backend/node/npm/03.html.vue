<template><div><h1 id="三、npm命令解析" tabindex="-1"><a class="header-anchor" href="#三、npm命令解析"><span>三、npm命令解析</span></a></h1>
<h2 id="_3-1-npm-install原理" tabindex="-1"><a class="header-anchor" href="#_3-1-npm-install原理"><span>3.1 npm install原理</span></a></h2>
<h3 id="_3-1-1-执行npm-install流程" tabindex="-1"><a class="header-anchor" href="#_3-1-1-执行npm-install流程"><span>3.1.1 执行npm install流程</span></a></h3>
<ol>
...
<h3 id="_3-1-2-扁平化处理" tabindex="-1"><a class="header-anchor" href="#_3-1-2-扁平化处理"><span>3.1.2 扁平化处理</span></a></h3>
...
<h3 id="_3-1-3-npm-install-再次执行流程" tabindex="-1"><a class="header-anchor" href="#_3-1-3-npm-install-再次执行流程"><span>3.1.3 npm install 再次执行流程</span></a></h3>
<ol>
...
<h3 id="_3-1-4-npmrc配置信息" tabindex="-1"><a class="header-anchor" href="#_3-1-4-npmrc配置信息"><span>3.1.4 npmrc配置信息</span></a></h3>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre v-pre><code><span class="line">registry=http<span class="token punctuation">:</span>//registry.npmjs.org/</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1-5-package-lock-json-的作用" tabindex="-1"><a class="header-anchor" href="#_3-1-5-package-lock-json-的作用"><span>3.1.5 package-lock.json 的作用</span></a></h3>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line">cache = "D://tool//node-v22.12.0//node_cache"</span>
...
<h2 id="_3-2-npm-run-原理" tabindex="-1"><a class="header-anchor" href="#_3-2-npm-run-原理"><span>3.2 npm run 原理</span></a></h2>
<h3 id="_3-2-1-npm-run-流程" tabindex="-1"><a class="header-anchor" href="#_3-2-1-npm-run-流程"><span>3.2.1 npm run 流程</span></a></h3>
...
<h3 id="_3-2-2-npm-生命周期" tabindex="-1"><a class="header-anchor" href="#_3-2-2-npm-生命周期"><span>3.2.2 npm 生命周期</span></a></h3>
<ol>
<li>npm生命周期的基本概念</li>
</ol>
