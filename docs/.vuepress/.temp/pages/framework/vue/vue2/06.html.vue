<template><div><h1 id="六、路由" tabindex="-1"><a class="header-anchor" href="#六、路由"><span>六、路由</span></a></h1>
<h2 id="_6-1-路由理解" tabindex="-1"><a class="header-anchor" href="#_6-1-路由理解"><span>6.1 路由理解</span></a></h2>
<ol>
<li>vue-router 的理解
<ul>
<li>vue的一个插件库，专门用来实现SPA应用</li>
</ul>
</li>
<li>对SPA应用的理解
<ol>
<li>单页Web应用（singlepagewebapplication，SPA）。</li>
<li>整个应用只有一个完整的页面。</li>
...
<h2 id="_6-2-基本路由" tabindex="-1"><a class="header-anchor" href="#_6-2-基本路由"><span>6.2 基本路由</span></a></h2>
<h3 id="_6-2-1-基本使用" tabindex="-1"><a class="header-anchor" href="#_6-2-1-基本使用"><span>6.2.1 基本使用</span></a></h3>
<ol>
<li>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//引入VueRouter</span></span>
...
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-link</span> <span class="token attr-name">active-class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>active<span class="token punctuation">"</span></span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/about<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>About<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-link</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol start="5">
<li>指定展示位置</li>
</ol>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-view</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-view</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="_6-2-2-几个注意点" tabindex="-1"><a class="header-anchor" href="#_6-2-2-几个注意点"><span>6.2.2 几个注意点</span></a></h3>
<ol>
<li>路由组件通常存放在pages文件夹，一半组件通常存放在components文件夹</li>
<li>通过切换，'隐藏'了路由组件，默认是被销毁掉的，需要的时候再去挂载。</li>
<li>每个组件都有自己的$route属性，里面存储着自己的路由信息。</li>
<li>整个应用只有一个router，可以通过组件的$router属性获取到。</li>
</ol>
<h2 id="_6-3-嵌套-多级-路由" tabindex="-1"><a class="header-anchor" href="#_6-3-嵌套-多级-路由"><span>6.3 嵌套（多级）路由</span></a></h2>
<ol>
...
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-link</span>  <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/home/news<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>News<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-link</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="_6-4-路由的query参数" tabindex="-1"><a class="header-anchor" href="#_6-4-路由的query参数"><span>6.4 路由的query参数</span></a></h2>
<ol>
<li>传递参数</li>
</ol>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- 跳转路由并携带query参数，to的字符串写法 --></span></span>
...
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line">$route.query.id</span>
<span class="line">$route.query.title</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-5-命名路由" tabindex="-1"><a class="header-anchor" href="#_6-5-命名路由"><span>6.5 命名路由</span></a></h2>
<p>作用：可以简化路由的跳转</p>
<p>如何使用</p>
<ol>
<li>给路由命名：</li>
...
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- 简化前，需要写完整的路径 --></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-6-路由的params参数" tabindex="-1"><a class="header-anchor" href="#_6-6-路由的params参数"><span>6.6 路由的params参数</span></a></h2>
<ol>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>特别注意：路由携带params参数时，若使用to的对象写法，则不能使用path配置项，必须使用name配置！</p>
<ol start="3">
<li>接受参数
<ul>
...
<h2 id="_6-7-路由的props配置" tabindex="-1"><a class="header-anchor" href="#_6-7-路由的props配置"><span>6.7 路由的props配置</span></a></h2>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-8-router-link-的replace属性" tabindex="-1"><a class="header-anchor" href="#_6-8-router-link-的replace属性"><span>6.8 <code v-pre>&lt;router-link&gt;</code>的replace属性</span></a></h2>
<ol>
<li>作用：控制路由跳转时操作浏览器历史记录的模式</li>
<li>浏览器的历史记录有两种写入方式： 分别为push和replace，push是追加历史记录，replace是替换当前记录。路由跳转默认为push</li>
<li>如何开启replace模式：<code v-pre>&lt;router-link replace ……&gt;</code>News<code v-pre>&lt;router-link&gt;</code></li>
</ol>
<h2 id="_6-9-编程式路由导航" tabindex="-1"><a class="header-anchor" href="#_6-9-编程式路由导航"><span>6.9 编程式路由导航</span></a></h2>
<ol>
<li>作用：不借助<code v-pre>&lt;router-link&gt;</code>实现路由跳转，让路由跳转更加灵活</li>
<li>具体编码：</li>
</ol>
<p>push跳转，类似往后追加</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
<span class="line">    <span class="token literal-property property">name</span><span class="token operator">:</span><span class="token string">'xiangqing'</span><span class="token punctuation">,</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span> </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>replace跳转，替换当前路由的url路径</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
<span class="line">    <span class="token literal-property property">name</span><span class="token operator">:</span><span class="token string">'xiangqing'</span><span class="token punctuation">,</span></span>
<span class="line">    <span class="token literal-property property">query</span><span class="token operator">:</span><span class="token punctuation">{</span></span>
<span class="line">        <span class="token literal-property property">id</span><span class="token operator">:</span>message<span class="token punctuation">.</span>id<span class="token punctuation">,</span></span>
<span class="line">        <span class="token literal-property property">title</span><span class="token operator">:</span>message<span class="token punctuation">.</span>title</span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span>  </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>路由的前进后退</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// 后退</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-10-缓存路由组件-keep-alive" tabindex="-1"><a class="header-anchor" href="#_6-10-缓存路由组件-keep-alive"><span>6.10 缓存路由组件<code v-pre>&lt;keep-alive&gt;</code></span></a></h2>
<ul>
<li>kee-alive 是 Vue 内置的一个组件，可以使被包含的组件保留状态，或避免重新渲染 , 也就是所谓的组件缓存。</li>
...
<h3 id="_6-10-1-根据条件缓存页面" tabindex="-1"><a class="header-anchor" href="#_6-10-1-根据条件缓存页面"><span>6.10.1 根据条件缓存页面</span></a></h3>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line">// 所有路径匹配到的视图组件都会被缓存！ </span>
...
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>keep-alive</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-10-2-meta-字段" tabindex="-1"><a class="header-anchor" href="#_6-10-2-meta-字段"><span>6.10.2 meta 字段</span></a></h3>
<p>可以在路由配置中使用 meta 字段来控制是否缓存特定的页面。
优点：不需要例举出需要被缓存组件名称</p>
<p>App.vue</p>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// router.js</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>meta 字段被用于控制缓存行为。</p>
<p>keepAlive 是一个自定义的字段，你可以根据需要设置为 true 或 false 来决定是否缓存该路由对应的组件。</p>
<h2 id="_6-11-两个新的生命周期钩子" tabindex="-1"><a class="header-anchor" href="#_6-11-两个新的生命周期钩子"><span>6.11 两个新的生命周期钩子</span></a></h2>
<p>问题？如果当前路由时缓存状态，是不会销毁的，如何确认跳转页面</p>
<p>代码：</p>
<p>路由展示页面</p>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>keep-alive</span> <span class="token attr-name">include</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>News<span class="token punctuation">"</span></span><span class="token punctuation">></span></span></span>
<span class="line">        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-view</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-view</span><span class="token punctuation">></span></span></span>
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>keep-alive</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Nes.vue</p>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span></span>
<span class="line">    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>作用：路由组件所独有的两个钩子，用于捕获路由组件的激活状态，只适用于keep-alive 。</li>
<li>具体名字：
<ol>
<li>activated路由组件被激活时触发。</li>
<li>deactivated路由组件失活时触发。</li>
</ol>
</li>
</ol>
<h2 id="_6-12-路由守卫" tabindex="-1"><a class="header-anchor" href="#_6-12-路由守卫"><span>6.12 路由守卫</span></a></h2>
<ol>
<li>
<p>作用：对路由进行权限控制</p>
</li>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">router<span class="token operator">/</span>index<span class="token punctuation">.</span>js</span>
...
<span class="line"></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-13-路由器的两种工作模式" tabindex="-1"><a class="header-anchor" href="#_6-13-路由器的两种工作模式"><span>6.13 路由器的两种工作模式</span></a></h2>
<p>vue 路由器的两种工作模式</p>
<p>Vue 路由器（Vue Router）主要用于构建单页面应用（SPA）。Vue Router 支持两种工作模式：hash 模式和history 模式。这两种模式决定了 URL 的结构，从而影响到浏览器的历史记录管理和页面的刷新行为。</p>
<h3 id="_6-13-1-hash-模式" tabindex="-1"><a class="header-anchor" href="#_6-13-1-hash-模式"><span>6.13.1 Hash 模式</span></a></h3>
<p>在 Hash 模式下，URL 中会包含一个 # 符号，后面跟着的是路由的路径。例如，http://example.com/#/user/id。</p>
<p>特点：
URL 中 # 号之后的内容不会发送到服务器。这意味着无论你如何改变 URL 中的路径，页面都不会向服务器发起请求。这对于不需要服务器端路由匹配的单页应用非常有用。</p>
<p>兼容性最好。即使在旧的浏览器上，这种模式也能正常工作。</p>
<p>不利于SEO。因为搜索引擎不会爬取 URL 中的 # 号之后的内容。</p>
<h3 id="_6-13-2-history-模式" tabindex="-1"><a class="header-anchor" href="#_6-13-2-history-模式"><span>6.13.2. History 模式</span></a></h3>
<p>在 History 模式下，URL 中不会有 # 符号，看起来更像普通的页面 URL。例如，http://example.com/user/id。</p>
<p>特点：
URL 看起来更美观，更加符合单页应用的预期。</p>
<p>需要服务器配置。因为当用户直接访问 URL 或刷新页面时，服务器必须配置为返回单页应用的入口页面（通常是 index.html），然后由前端路由接管接下来的路由跳转。否则，用户会看到404错误。</p>
<p>支持 SEO。由于 URL 不包含 #，搜索引擎可以正常爬取页面内容。</p>
<p>兼容性：需要浏览器的 History API 支持（大多数现代浏览器都支持）。对于不支持 History API 的旧浏览器，可以回退到 Hash 模式。</p>
<h3 id="_6-13-3-如何选择" tabindex="-1"><a class="header-anchor" href="#_6-13-3-如何选择"><span>6.13.3 如何选择？</span></a></h3>
<p>如果你的应用主要面向现代浏览器用户，并且你希望有一个更美观的 URL，同时希望利用 SEO 的优势，那么选择 History 模式是更好的选择。</p>
<p>如果你的应用需要兼容老旧浏览器，或者你不希望对服务器进行配置，那么使用 Hash 模式可能更简单一些。</p>
<h3 id="_6-13-4-配置示例" tabindex="-1"><a class="header-anchor" href="#_6-13-4-配置示例"><span>6.13.4 配置示例</span></a></h3>
<ol>
<li>Hash 模式配置：</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">VueRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于 History 模式，你还需要在服务器端进行适当的配置，以确保当用户直接访问一个路由时，服务器能够返回应用的入口页面（通常是 index.html），然后由前端路由来处理后续的路由跳转。例如，在 Node.js 中，你可以使用 Express 来实现：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>express<span class="token punctuation">.</span><span class="token function">static</span><span class="token punctuation">(</span>__dirname <span class="token operator">+</span> <span class="token string">'/dist'</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 设置静态文件目录为dist文件夹</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样，无论用户访问哪个 URL，服务器都会返回 index.html 文件，而具体的路由跳转则由 Vue Router 在前端处理。</p>
</div></template>
