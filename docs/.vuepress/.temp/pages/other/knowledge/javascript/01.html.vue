<template><div><h1 id="apply、call、bind的区别" tabindex="-1"><a class="header-anchor" href="#apply、call、bind的区别"><span>apply、call、bind的区别</span></a></h1>
...
<h2 id="_1-call-函数" tabindex="-1"><a class="header-anchor" href="#_1-call-函数"><span>1. call()函数</span></a></h2>
<ul>
<li>语法：fn.call(thisArg，arg1，arg2.....)
<ul>
<li>其中thisArg就是fun函数运行时的指定的this值。arg1，arg2传递的其他值.....</li>
<li>其中thisArg有下面4种情况：
<ol>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-apply-函数" tabindex="-1"><a class="header-anchor" href="#_2-apply-函数"><span>2. apply()函数</span></a></h2>
<ul>
<li>语法：fn.apply(thisArg，[arg1，arg2.....])</li>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-bind-函数" tabindex="-1"><a class="header-anchor" href="#_3-bind-函数"><span>3. bind()函数</span></a></h2>
<ul>
<li>语法：fn.bind(thisArg[, arg1[, arg2[, ... ]]]);
<ul>
<li>thisArg:当绑定函数被调用时，该函数会作为原函数运行时的this指向，当使用new操作符调用绑定函数时，该参数无效。</li>
