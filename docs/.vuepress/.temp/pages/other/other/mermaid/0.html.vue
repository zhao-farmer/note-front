...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-2qkvcsn">
            gantt
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-o0gb4sx">
            gantt
    dateFormat  YYYY-MM-DD
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-q15j9j4">
            gantt
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-dn6qvei">
            gantt
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-5dcyu6x">
            gantt
    dateFormat HH:mm
    axisFormat %H:%M
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-t2qejpx">
            gantt
  tickInterval 1week
  weekday monday
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-joiaq2b">
            ---
displayMode: compact
---
gantt
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-jzgxmn8">
            gantt
    title A Gantt Diagram
    %% This is a comment
    dateFormat YYYY-MM-DD
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-l2ecooe">
            gantt
