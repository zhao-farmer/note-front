<template><div><h1 id="零、mermaid基础知识" tabindex="-1"><a class="header-anchor" href="#零、mermaid基础知识"><span>零、mermaid基础知识</span></a></h1>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-mermaid使用npm引入" tabindex="-1"><a class="header-anchor" href="#_3-mermaid使用npm引入"><span>3. Mermaid使用npm引入</span></a></h2>
<ol>
<li>安装</li>
</ol>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-tl094mf">
            ---
title: Hello Title
config:
  theme: base
...
<li>初始化的序列图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-et0hasl">
            sequenceDiagram
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="_6-注意点" tabindex="-1"><a class="header-anchor" href="#_6-注意点"><span>6. 注意点</span></a></h2>
<ol>
<li>转义所有尖括号</li>
</ol>
<ul>
...
<ul>
<li>如果文本包含 <code v-pre>[]</code>, <code v-pre>()</code>, <code v-pre>&lt;br&gt;</code>, <code v-pre>/</code> 或<code v-pre>空格</code>，必须用双引号包裹：<code v-pre>[&quot;Text with symbols&quot;]</code></li>
<li>重要提示：箭头后的节点定义必须立刻接双引号，例如 --&gt; <code v-pre>C[&quot;描述文本&quot;]</code></li>
</ul>
<ol start="3">
<li>换行符保留规则</li>
</ol>
<ul>
<li><code v-pre>&lt;br&gt;</code> 可以正常使用，但必须位于双引号包裹的文本块内</li>
</ul>
<ol start="4">
<li>箭头语法的纯净性</li>
</ol>
<ul>
<li>确保连接符 <code v-pre>--&gt;</code> 后面紧跟节点定义，不要掺杂未包裹的文本</li>
</ul>
<ol start="5">
<li>类图最好不要以 <code v-pre>{}</code> 结尾，vue页面识别错误</li>
</ol>
<p>可以加上end</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-在线使用" tabindex="-1"><a class="header-anchor" href="#_7-在线使用"><span>7. 在线使用</span></a></h2>
<p>网站：<code v-pre>https://mermaid-live.nodejs.cn/</code></p>
</div></template>
