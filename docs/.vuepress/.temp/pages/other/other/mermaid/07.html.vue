...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-g342pw4">
            gantt
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-y80ut65">
            gantt
    dateFormat  YYYY-MM-DD
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-3tx4bl7">
            gantt
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-yhkx2rw">
            gantt
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-b3c48wb">
            gantt
    dateFormat HH:mm
    axisFormat %H:%M
...
<p>更多信息请访问：<code v-pre>https://day.js.org/docs/en/parse/string-format/</code></p>
...
<p>更多信息请访问：<code v-pre>https://github.com/d3/d3-time-format/tree/v4.0.0#locale\_format</code></p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>更多信息请访问：<code v-pre>https://github.com/d3/d3-time#interval\_every</code></p>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-ojoepp2">
            gantt
  tickInterval 1week
  weekday monday
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-jn8cv5s">
            ---
displayMode: compact
---
gantt
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-h3a08p9">
            gantt
    title A Gantt Diagram
    %% This is a comment
    dateFormat YYYY-MM-DD
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-bv07hvf">
            gantt
