...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-e0bzhw1">
            C4Context
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-w1jpeqm">
            C4Context
      title System Context diagram for Internet Banking System
      Enterprise_Boundary(b0, "BankBoundary0") {
        Person(customerA, "Banking Customer A", "A customer of the bank, with personal bank accounts.")
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-vyhjz78">
            C4Container
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-gn74cuy">
             C4Component
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-5k6xkef">
            C4Dynamic
...
<li>展示图</li>
          ...
          <pre class="mermaid" id="mermaid-93oyt92">
             C4Deployment
