<template><div><h1 id="十五、桑基图" tabindex="-1"><a class="header-anchor" href="#十五、桑基图"><span>十五、桑基图</span></a></h1>
<blockquote>
<p>桑基图是用于描述从一组值到另一组值的流的可视化图。</p>
</blockquote>
<blockquote>
<ol>
<li>这是一张实验图。它的语法非常接近纯CSV，但它将在不久的将来得到扩展。</li>
<li>被连接的东西被称为节点，连接被称为链接。</li>
</ol>
</blockquote>
<h2 id="_15-1-例子" tabindex="-1"><a class="header-anchor" href="#_15-1-例子"><span>15.1 例子</span></a></h2>
<p>这个例子取自observable。不过，在大小和颜色方面，它可能会被渲染得有点不同。</p>
<ul>
<li>代码</li>
</ul>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-fj3vi8h">
            ---
config:
  sankey:
    showValues: false
...
Wind,Electricity grid,289.366
        ...
        <h2 id="_15-2-语法" tabindex="-1"><a class="header-anchor" href="#_15-2-语法"><span>15.2 语法</span></a></h2>
<p>语法背后的思想是，用户首先键入 <code v-pre>sankey-beta</code> 关键字，然后在下面粘贴原始CSV并获得结果。</p>
<p>它实现了如下描述的CSV标准，有细微的差别：</p>
<ul>
<li>CSV只能包含3列</li>
<li>出于视觉目的，允许使用不带逗号分隔符的空行</li>
</ul>
<h3 id="_15-2-1-基本" tabindex="-1"><a class="header-anchor" href="#_15-2-1-基本"><span>15.2.1 基本</span></a></h3>
<p>这意味着CSV中的3列应该分别代表 <code v-pre>source</code> ,  <code v-pre>target</code> 和 <code v-pre>value</code> ：</p>
<ul>
<li>代码</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">sankey-beta</span>
<span class="line"></span>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-xrs3uaj">
            sankey-beta
...
Electricity grid,H2 conversion,27.14
        ...
        <h3 id="_15-2-2-空行" tabindex="-1"><a class="header-anchor" href="#_15-2-2-空行"><span>15.2.2 空行</span></a></h3>
<p>CSV默认不支持不带逗号分隔符的空行。但如果需要，你可以添加它们：</p>
<ul>
<li>代码</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">sankey-beta</span>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-8llx3az">
            sankey-beta
...
Bio-conversion,Gas,81.144
        ...
        <h3 id="_15-2-3-逗号" tabindex="-1"><a class="header-anchor" href="#_15-2-3-逗号"><span>15.2.3 逗号</span></a></h3>
<p>如果你需要逗号，用双引号括起来：</p>
<ul>
<li>代码</li>
</ul>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-24ok8ni">
            sankey-beta
...
Pumped heat,"Heating and cooling, commercial",70.672
        ...
        <h3 id="_15-2-4-双引号" tabindex="-1"><a class="header-anchor" href="#_15-2-4-双引号"><span>15.2.4 双引号</span></a></h3>
<p>如果你需要双引号，把一对双引号放在带引号的字符串里：</p>
<ul>
<li>代码</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">sankey-beta</span>
...
<li>展示图</li>
          ...
          <code>
          <pre class="mermaid" id="mermaid-i0drp4x">
            sankey-beta
...
Pumped heat,"Heating and cooling, ""commercial""",70.672
        ...
        <h2 id="_15-3-配置" tabindex="-1"><a class="header-anchor" href="#_15-3-配置"><span>15.3 配置</span></a></h2>
<p>您可以自定义链接颜色、节点对齐方式和图表尺寸。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_15-3-1-链接颜色" tabindex="-1"><a class="header-anchor" href="#_15-3-1-链接颜色"><span>15.3.1  链接颜色</span></a></h3>
<p>你可以通过设置 <code v-pre>linkColor</code> 来调整链接的颜色：</p>
<ul>
<li><code v-pre>source</code>  - link将为源节点颜色</li>
<li><code v-pre>target</code>  - link将是目标节点的颜色</li>
<li><code v-pre>gradient</code>  -链接颜色将在源节点和目标节点颜色之间平滑过渡</li>
<li>颜色的十六进制代码，如 <code v-pre>#a1a1a1</code></li>
</ul>
<h3 id="_15-3-2-节点对齐" tabindex="-1"><a class="header-anchor" href="#_15-3-2-节点对齐"><span>15.3.2 节点对齐</span></a></h3>
<p>通过设置 <code v-pre>nodeAlignment</code> 为，可以改变图形布局：</p>
<ul>
<li><code v-pre>justify</code></li>
<li><code v-pre>center</code></li>
<li><code v-pre>left</code></li>
<li><code v-pre>right</code></li>
</ul>
</div></template>
