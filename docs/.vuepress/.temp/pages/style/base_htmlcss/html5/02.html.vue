<template><div><h1 id="二、新增语义化标签" tabindex="-1"><a class="header-anchor" href="#二、新增语义化标签"><span>二、新增语义化标签</span></a></h1>
<h2 id="_2-1-新增布局标签" tabindex="-1"><a class="header-anchor" href="#_2-1-新增布局标签"><span>2.1 新增布局标签</span></a></h2>
<table>
<thead>
<tr>
<th>标签名</th>
...
<p><strong>关于 <code v-pre>article</code> 和 <code v-pre>section</code></strong>：</p>
<ol>
<li>artical 里面可以有多个 section 。</li>
<li>section 强调的是分段或分块，如果你想将一块内容分成几段的时候，可使用 section 元 素。</li>
<li>article 比 section 更强调独立性，一块内容如果比较独立、比较完整，应该使用 article 元素。</li>
</ol>
<h2 id="_2-2-新增状态标签" tabindex="-1"><a class="header-anchor" href="#_2-2-新增状态标签"><span>2.2 新增状态标签</span></a></h2>
<h3 id="_2-2-1-meter-标签" tabindex="-1"><a class="header-anchor" href="#_2-2-1-meter-标签"><span>2.2.1 meter 标签</span></a></h3>
<p><strong>语义</strong>：</p>
<blockquote>
<p>定义已知范围内的标量测量。也被称为 gauge （尺度），双标签，例如：电量、磁盘用量 等。</p>
</blockquote>
...
<h3 id="_2-2-2-progress-标签" tabindex="-1"><a class="header-anchor" href="#_2-2-2-progress-标签"><span>2.2.2 progress 标签</span></a></h3>
<p><strong>语义</strong>：</p>
<blockquote>
<p>显示某个任务完成的进度的指示器，一般用于表示进度条，双标签，例如：工作完成进度 等。</p>
</blockquote>
<p><strong>常用属性如下</strong>：</p>
<table>
<thead>
...
<h2 id="_2-3-新增列表标签" tabindex="-1"><a class="header-anchor" href="#_2-3-新增列表标签"><span>2.3 新增列表标签</span></a></h2>
<table>
<thead>
<tr>
<th>标签名</th>
...
<tr>
<td>summary</td>
<td>写在details的里面，用于指定问题或专有名词</td>
<td>双</td>
</tr>
</tbody>
</table>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text<span class="token punctuation">"</span></span> <span class="token attr-name">list</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>mydata<span class="token punctuation">"</span></span><span class="token punctuation">></span></span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-新增文本标签" tabindex="-1"><a class="header-anchor" href="#_2-4-新增文本标签"><span>2.4 新增文本标签</span></a></h2>
<h3 id="_2-4-1-文本注音" tabindex="-1"><a class="header-anchor" href="#_2-4-1-文本注音"><span>2.4.1 文本注音</span></a></h3>
<table>
<thead>
<tr>
<th>标签名</th>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-2-文本标记" tabindex="-1"><a class="header-anchor" href="#_2-4-2-文本标记"><span>2.4.2 文本标记</span></a></h2>
<table>
<thead>
<tr>
<th>标签名</th>
...
<blockquote>
<p>注意： W3C 建议 mark 用于标记搜索结果中的关键字。</p>
</blockquote>
</div></template>
