...
5. 打开 `http://localhost:4000/graphql` 并添加参数观察结果
    ...
    ![](/framework/react/records/001.png)
...
2. 使用复杂数据类型
    ...
    - 调用结果
        ...
        ![](/framework/react/records/002.png)
...
3. 传递参数
    ...
    - 调用结果
        ...
        ![](/framework/react/records/003.png)
...
2. 查询数据
    ...
    - 运行结果
        ...
        ![](/framework/react/records/004.png)
...
2. 新增数据
    ...
    - 运行结果
        ...
        ![](/framework/react/records/005.png)
...
3. 修改数据
    ...
    - 运行结果
        ...
        ![](/framework/react/records/006.png)
...
4. 删除数据
    ...
    - 运行结果
        ...
        ![](/framework/react/records/007.png)
...
3. 各种操作
    ...
    - 新增数据
        ...
        ![](/framework/react/records/008.png)
    - 查询数据

        ![](/framework/react/records/009.png)
    - 修改数据

        ![](/framework/react/records/010.png)
    - 删除数据

        ![](/framework/react/records/011.png)
...
2. 新增 静态页面 `public/home.html`
    ...
    - 页面效果
        ...
        ![](/framework/react/records/016.png)

3. 点击按钮操作

    - 查询数据

        ![](/framework/react/records/012.png)
    - 创建数据

        ![](/framework/react/records/013.png)
    - 更新数据

        ![](/framework/react/records/014.png)
    - 删除数据

        ![](/framework/react/records/015.png)
...
4. 运行结果
    ...
    - 页面效果(查询)
        ...
        ![](/framework/react/records/020.png)
    - 新增数据

        ![](/framework/react/records/017.png)
    - 修改数据

        ![](/framework/react/records/018.png)
    - 删除数据

        ![](/framework/react/records/019.png)